...
import NotifAddLaporanOperator from '../notif/notifAddLaporanOperator';

export default function FormAddLaporanOperator({ onClose, onAdd }) {
  ...
  return (
    <>
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-8">
        {/* Header */}
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 text-center">Tambah Operator Baru</h2>
        </div>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-200 rounded-xl px-4 py-3 text-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-200 rounded-xl px-4 py-3 text-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500"
                placeholder="Contoh: 087685384285"
              />
            </div>
            <div>
              <label className="block text-gray-900 font-semibold mb-2">
              ...
              <input
                ...
                className="w-full bg-gray-200 rounded-xl px-4 py-3 text-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500"
                placeholder="Contoh: raisya@gmail.com"
              />
            </div>
          </div>
      ...
      {/* Notifikasi Add Operator */}
      {showNotif && (
        <NotifAddLaporanOperator onClose={handleCloseNotif} />
      )}
    </>
  );
}