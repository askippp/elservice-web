...
import NotifAddSparepart from '../notif/notifAddSparepart';
...
export default function FormAddSparepart({ isOpen, onClose }) {
  ...
  return (
    <>
      {showNotif && (
        <NotifAddSparepart onClose={handleNotifClose} />
      )}
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex justify-end gap-4 pt-4">
              <button
                ...
                className="px-8 py-3 bg-purple-500 text-white font-semibold rounded-2xl hover:bg-purple-600 transition-colors shadow-lg"
              >
                Tambah
              </button>
              <button
                onClick={handleCancel}
                className="px-8 py-3 bg-red-600 text-white font-semibold rounded-2xl hover:bg-red-700 transition-colors shadow-lg"
              >
                Cancel
              </button>
            </div>
