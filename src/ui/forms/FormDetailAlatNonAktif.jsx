...
import NotifUpdateAlat from "../notif/notifUpdateAlat";
    ...
    <>
      <div className="bg-white rounded-3xl overflow-hidden shadow-2xl">
        ...
        <div className="p-8">
          {/* Image */}
          <div className="mb-6">
            <div className="border-4 border-gray-400 rounded-2xl overflow-hidden">
              <img 
      ...
      {/* Notifikasi Update */}
      {showNotif && (
        <NotifUpdateAlat onClose={handleNotifClose} />
      )}
    </>
  );
}