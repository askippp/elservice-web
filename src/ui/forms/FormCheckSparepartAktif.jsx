...
export default function FormCheckSparepartAktif({ sparepart, onClose, onUpdate }) {
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-1/2 px-4 py-2.5 bg-white border-2 border-purple-500 rounded-lg text-sm font-medium text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-500 appearance-none"
                  style={{
